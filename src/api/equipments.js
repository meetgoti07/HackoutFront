...
export const createEquipment = async ({
  ...
  try {
      console.log(owner, manufacturer, title, description, equipment_type, available_start_time, available_end_time, equipment_location, daily_rental, hourly_rental, manufacturing_year, model, condition, horsepower, width, height);
    const headers = {
      "Content-Type": "application/json",
      Authorization: `Bearer ${Cookies.get("access-token")}`,
    };
